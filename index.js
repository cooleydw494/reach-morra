...
class Player extends React.Component {
  ...
  // TODO: need to handle the "Time To Play Again Case?"
  seeResult(result) { this.setState({ view: 'Done', outcome: RESULT[result] }); }
  informTimeout(whoTimedOut) { this.setState({ view: 'Timeout', whoTimedOut: PLAYERNAMES[whoTimedOut] }); }
  playHand(hand) { this.state.resolveHandP(hand); }
  sendGuess(guess) { this.state.resolveGuessP(guess); }
}
